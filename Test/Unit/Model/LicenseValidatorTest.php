...
namespace ETechFlow\OrderEmailEditor\Test\Unit\Model;
...
/**
 * Portal-only licensing tests for ETechFlow_OrderEmailEditor.
 *
...
class LicenseValidatorTest extends TestCase
{
    ...
    public function testExplicitRevokeFlagWinsOverEverything(): void
    {
        ...
        $this->setConfig([
            LicenseValidator::XML_PATH_LICENSE_KEY    => 'SP-live-abc123',
            LicenseValidator::XML_PATH_PORTAL_API_URL => self::PORTAL,
            'etechflow_orderemaileditor/license/revoked' => '1',
        ]);
        $this->setCacheMiss();
    ...
    public function testForgedKeyAndAttackerControlledConfigCannotBypass(): void
    {
        ...
        $this->setConfig([
            ...
            'etechflow_orderemaileditor/license/issued_key'  => 'SP-i-made-this-up',
            'etechflow_orderemaileditor/license/issued_at'   => (string) time(),
            'etechflow_orderemaileditor/license/ip_blocked'  => '0',
        ]);
        // No cached genuine success exists for them, and the portal is unreachable.
        $this->setCacheMiss();
        $this->setPortalResponse(0, '');
    ...
    public function testGraceFromPriorSuccessKeepsStorefrontLiveWhilePortalUnreachable(): void
    {
        ...
        // Default portal is reached but the network is down this request.
        $this->setPortalResponse(0, '');

        // A genuine portal success was cached recently (only writeGrace can do this).
        $graceKey = 'etf_oee_lic_grace_' . md5($host . ':' . $key);
    ...
    public function testGraceDoesNotApplyToADifferentHost(): void
    {
        ...
        $goodGraceKey = 'etf_oee_lic_grace_' . md5('shop.example.com:SP-live-abc123');
        $this->cache->method('load')->willReturnCallback(
